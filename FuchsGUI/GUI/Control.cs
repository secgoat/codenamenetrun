    ...
    public abstract class Control
    {
        ...
        public virtual void Draw(SpriteBatch spriteBatch)
        {
            ...
            if (text != "" && font != null)
            {
                ...
                spriteBatch.DrawString(font, text, textPos, foreColor, 0.0f, Vector2.Zero, new Vector2(1,1), SpriteEffects.None, 0.0f);
            }
        }
        ...
        protected Vector2 CalculateTextPosition()
        {
            ...
            if (TextPosition == TextPosition.Center)
                ...
                textPos = AbsPosition + new Vector2((positionWidthHeight.Width - font.MeasureString(text).X) / 2f, 0);
            else
